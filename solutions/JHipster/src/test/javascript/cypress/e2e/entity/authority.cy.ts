...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '4d5b66ce-2074-4107-b898-33ec5a64012d' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('a4536ae5-82eb-4a8b-8e63-3f6df8d123ce');
      cy.get(`[data-cy="name"]`).should('have.value', 'a4536ae5-82eb-4a8b-8e63-3f6df8d123ce');
